...
```javascript
formatInterpolate = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-format-interpolate@v0.0.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/string-base-format-interpolate/actions/workflows/test.yml/badge.svg?branch=v0.0.3
[test-url]: https://github.com/stdlib-js/string-base-format-interpolate/actions/workflows/test.yml?query=branch:v0.0.3
